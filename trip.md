...
- 打包原則：護照、付款工具、藥品、電腦、平板與行動電源一律放身上／後背包，不放托運；剪刀與指甲剪放入托運行李箱；其中行動電源依航空規則不得托運。
- 完整 71 項互動式行李清單在網站的行李頁；本檔只保留分裝決策與維護規則。
...
- **🎒 後背包（17 項，分 4 組）**（飛機、機場、火車、飯店會用，或貴重不能托運）：
  - **3C／電器**：MacBook、iPad、Sony WH-1000XM6 耳機、3.5 mm 飛機耳機線、GaN 充電器、C-C & A-C 充電線、轉接頭。
