...
## 09/12 法國伴手禮清單全面翻新：辦公室與朋友 8 款代表性精選、全站 20 款動態架構（2026-09-12）

- **法國選品全面淘汰舊版並升級為 8 款精選（4 款辦公室分享、4 款送朋友選品）**：
  - 全站伴手禮候選總數調整為 20 款（瑞典 6 款、丹麥 6 款、法國 8 款）。
  - 全面更新官方高解析純白實物圖（Packshot），尺寸統一為 800x500 16:10 WebP 規格。
- **🇫🇷 法國 · 巴黎（8 款選品）**：
  - **辦公室多人分享（4 款）**：
...
- **全站快取與版本升級**：PWA 快取版本提升至 `eccv-guide-v20260912-01`，全站 HTML 與 Service Worker 快取清單同步更新，8 款全新 WebP 圖檔納入離線快取。
