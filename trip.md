    - **Pierre Hermé 經典馬卡龍（推薦招牌 Ispahan 玫瑰荔枝覆盆子）**：約 2.8–26.0 EUR（約 NT$100–940），專門店或老佛爺專櫃購，甜點界愛馬仕，天然玫瑰、荔枝與覆盆子層次細膩；效期短且極脆易碎，建議巴黎現吃或於回台當天（09/18）手提上機護送。
    - **鵝肝醬 / 鴨肝醬罐頭（Foie Gras Entier 純肥肝抹醬）**：約 6.0–50.0 EUR+（約 NT$215–1,800+），老佛爺美食館或超市購，法式奢華料理精華；注意入境台灣務必認明為常溫高溫高壓商業滅菌之純密封鐵罐／玻璃罐，嚴禁含生鮮肉塊，超過 100ml 須託運。
    - **Messi × PSG 30 號時期紀念收藏（球員卡／公仔／海報與絕版周邊）**：約 5.0–45.0 EUR+（約 NT$180–1,600+），PSG 香榭旗艦店、塞納河畔舊書攤（Bouquinistes）或聖圖安跳蚤市場購，Messi 於 2021–2023 年效力巴黎身披重回起點的 30 號球衣，現已屬絕版舊時期紀念品，極具旅行紀念與足球歷史價值；卡片與海報極輕便好攜帶。
- **全站快取與版本升級**：PWA 快取版本提升至 `eccv-guide-v20260912-02`，全站 HTML 與 Service Worker 快取清單同步更新，9 款 WebP 圖檔完整納入離線快取。

## 09/11 伴手禮指南全面擴充：三國 19 款代表性選品、真實實物圖與動態架構升級（2026-09-11）

- **三國 19 款代表性選品架構（不硬性全買，作為逛店選購指南）**：
  - 伴手禮指南擴充至 19 款候選，涵蓋在地傳統食品、特色糖果甜點、設計工藝品、實用生活小物與博物館文創。
  - 介面與資料全面升級為動態計數（`souvenirsData.items` 計算總數、各國數量、辦公室數量、朋友數量），徹底移除 UI 寫死數字。
  - 引入真實官方與實物照片（全面替換手繪圖，採用高解析 WebP 格式），並增設現場決策標籤（如「很推薦」、「適合 Team 分享」、「好攜帶」等）。
- **🇸🇪 瑞典 · Malmö（6 款選品）**：
  - **Dalahäst 達拉木馬**：約 100–300 SEK（約 NT$310–930），市區紀念品店／設計店購，瑞典最具代表性傳統彩繪木馬工藝，非食品易保存，建議選 5–7 cm 小尺寸。
  - **Ahlgrens Bilar 經典汽車軟糖**：約 20–35 SEK（約 NT$60–110），ICA / Coop 超市購，瑞典國民零食，三色小車棉花糖口感，份量輕巧適合辦公室 16 人 Team 分享。
  - **Cloetta Kexchoklad 威化牛奶巧克力**：約 10–30 SEK（約 NT$30–95），各大超市購，瑞典國民威化餅乾，酥脆香濃且接受度極高，可平衡甘草口味。
  - **Malmö Chokladfabrik 70% 有機黑巧克力磚**：約 45 SEK（約 NT$140），馬爾默超市或 Saluhall 市集購，在地近 140 年歷史知名品牌，純黑可可伴手禮。
  - **Malaco Djungelvrål 猴子鹹甘草糖**：約 20–40 SEK（約 NT$65–125），超市購，北歐代表性 Salmiak 鹹甘草，文化體驗挑戰系伴手禮。
  - **Polkagris 瑞典百年傳統紅白薄荷拐杖糖**：約 30–80 SEK（約 NT$95–250），傳統糖果店購，Gränna 百年手工拉糖，薄荷清香且耐常溫。
- **🇩🇰 丹麥 · 哥本哈根（6 款選品）**：
  - **法國新鮮生乳起司（Brie / Camembert 等軟質乳酪）**：需全程冷藏，且台灣入境檢疫對生乳及未熟成軟質起司限制嚴格。
  - **法國頂級鮮奶油與發酵奶油（Beurre de Baratte）**：需全程 2–6°C 冷藏，常溫跨洲飛行必融化油水分離。
  - **法國熟肉火腿與香腸肉製品（Saucisson / Rillettes）**：台灣海關動植物防疫檢疫法規嚴禁攜帶任何豬肉、牛羊禽肉製品入境，違者重罰最高 NT$1,000,000。
- **伴手禮真實實物／包裝圖全面校正升級**：全面校驗並替換 19 款伴手禮圖片，淘汰所有廚房工場、店內景觀或混亂開箱背景，替換為純粹的官方實物與包裝圖（Packshot）：
  - **Alain Ducasse**：由原本巧克力製作工場廚房照片，替換為展示 21 顆精美手工巧克力的官方經典紙盒禮盒實物圖。
  - **羅浮宮文創**：由原本金字塔內部建築景觀，替換為羅浮宮官方紀念品店金字塔線條黑色帆布托特包（Tote Bag）官方實物圖。
  - **Mariage Frères**：由原本茶室店內裝潢景觀，替換為經典黑色金屬茶罐（Marco Polo）官方包裝實物圖。
  - **LEGO 人偶**：由原本開箱散落一桌的混雜照片，替換為經典旅行探險家背包地圖人偶乾淨純白背景特寫實物圖。
  - **Royal Dansk**：確認採用 Ferrero 官方經典藍罐 32oz 圓形鐵盒純白背景包裝圖。
  - **其餘品項**（達拉木馬、馬爾默純黑巧、Bülow 甘草球雙罐、皇家哥本哈根唐草瓷盤、喬治傑生大象開瓶器、安徒生/Anthon Berg 巧克力、Angelina 奶油餅乾鐵盒、Maille 第戎芥末醬、鹽之花、馬賽皂等）皆經嚴格視覺檢驗，確認為獨立商品實物或包裝本體。
- **全站快取與版本升級**：PWA 快取版本提升至 `eccv-guide-v20260911-03`，全站 HTML 與 Service Worker 快取清單同步更新，19 款真實 WebP 圖檔納入離線快取。
...
- **景點偏好優先級**：
  1. 科技／互動體驗（Tech / interactive experiences）
  2. 美食（Food）
  3. 城市地標／建築（City landmarks / architecture）
  4. 傳統博物館（Traditional museums）
  5. 自然／海景（Nature / seaside scenery）
- **行程取捨與規劃決策順位（二選一抉擇原則）**：
  - **個人興趣優先 ➔ 地理順向（單向不折返） ➔ 少轉乘 ➔ 步數合理 ➔ 充分休息 ➔ 知名但無趣的純觀光打卡點**。
  - 拒絕在城市地圖上隨機散落知名打卡點並折返受苦；哥本哈根與巴黎皆以「單一地理動線」為核心原則。
- **每日節奏與行動約束**：
  - **步調休閒**：每天抓 2 到 3 個重點，交通與休息時間計入行程。
  - **區域集中與單向推進**：景點按區域歸納，行程沿單一方向流暢推進，徹底避免市區來回折返與多餘的跨城移動。
  - **少轉乘勝過省 10 分鐘**：寧可在單一列車上多坐片刻，避免在複雜的地鐵／火車系統中穿梭轉乘。
  - **每日步數目標**：舒適區間為 10,000 到 15,000 步，上限盡量控制在 20,000 步以內。
  - **怕熱與體能調節**：主動穿插室內站點、咖啡館、商場、博物館、補水與中途休息，避免長時間室外曝曬。
  - **跨海頻率限制**：從馬爾默前往哥本哈根觀光最多兩天，避免跨海通勤疲勞。
  - **以 ECCV 為錨點**：特別是 09/10 發表日，觀光絕對不得干擾或壓縮研討會議程。
...
- **機場會合時間調整**：
  - 個人搭乘阿聯酋航空 EK 151 已於 13:15 抵達哥本哈根機場 T3、順利入境並提領行李。
  - 同行友人班機預計最早已延至 16:55 降落，最快約 17:30 提領行李完成並於接機大廳出口旁會合。
  - 14:15 - 17:30 安排於 T3 航廈咖啡店（如 Espresso House）休息充電、連線機場 Wi-Fi、調整時差並預先以手機 Skånetrafiken App 設定跨境車票。
- **跨海交通與入住時程銜接**：
  - 17:30 友人會合後，前往 T3 火車站第 1 月台搭乘跨海列車 Øresundståg 直達瑞典 Hyllie Station（車程約 15 分鐘，備妥護照因應抽檢）。
  - 18:15 於 Hyllie 站前轉乘 Bus 9 直達營區周邊 Götgatan 站，沿 Strandgatan 步行約 7 分鐘抵達 First Camp Sibbarp-Malmö。
  - 18:50 - 19:30 抵達接待處辦理小木屋入住手續並領取鑰匙（原預約 18:00 - 19:00 入住，若因出關稍微延遲超過 19:00，可致電 `+46 40 15 51 65` 告知並由接待處安排晚到自助取鑰）。
  - 入住後安頓行李、整理廚房，視精神狀況於周邊採買簡單食材或散步休息。

## 旅行翻譯影像管線升級：雙區塊結構化輸出與 Samsung S23 排版強化（2026-09-07）

- **Prompt 升級**：將圖片翻譯 System Prompt 與 User Prompt 強化為雙區塊結構（【場景簡述】與【完整翻譯】），前置 1-2 句摘要說明圖片場景，引導 Vision LLM（如 Gemini Flash-Lite / Qwen 等小參數量模型）注意力錨定，大幅降低海量文字漏翻或中途截斷問題，並要求窮盡翻譯所有項目、餐點、金額與說明。
- **雙區塊獨立 UI 與優雅降級**：
  - 上層獨立顯示「💡 場景簡述」醒目卡片，下層為完整翻譯結果。
  - 複製按鈕支援一鍵整併複製（包含場景簡述＋翻譯結果）；純文字翻譯時複製純譯文。
  - 斷網或離線 ML Kit 模式、以及純文字翻譯時，自動隱藏場景簡述卡，維持零空間浪費與零破版。
- **排版與視覺驗證**：針對 Samsung Galaxy S23（390px 寬度）單手直式畫面與桌面版（1280px）、包含深淺色模式完成視覺對齊驗證。

## 行李物品調整：移除後背包 iPad（2026-09-06）

- **後背包・3C／電器**：移除「iPad」（後背包由 17 項減至 16 項，全站行李清單由 71 項減至 70 項）。
- **打包原則同步**：後背包 3C 物品保留 MacBook、Sony WH-1000XM6 耳機、3.5 mm 飛機耳機線、GaN 充電器、C-C & A-C 充電線、轉接頭；安全提示文字同步移除 iPad。

## 行李物品調整：剪刀與指甲剪移至托運行李箱、隨身小包新增飲料提袋（2026-09-06）

- **隨身小包・個人日用**：新增「飲料提袋」（隨身小包共 15 項）。
- **後背包・藥品／工具**：移除「剪刀」與「指甲剪」（後背包共 17 項）。
- **托運行李箱・行李／其他**：新增「剪刀」與「指甲剪」（托運行李箱共 39 項）。
- **打包原則同步**：剪刀與指甲剪放入托運行李箱；隨身小包攜帶飲料提袋。

## 09/06 出發段行程補齊：古亭捷運站經北門轉乘機捷直達桃機 T2（2026-09-06）

- **古亭至桃機動線補齊**：
  - 20:00 古亭捷運站刷卡進站，搭乘松山新店線（往松山方向，車程約 7 分鐘）直達北門站。
  - 20:15 - 20:25 從北門站經地下連通道步行約 7 分鐘抵達機場捷運 A1 台北車站，刷卡進站至直達車月台。
  - 20:30 搭乘機捷直達車（車程約 39 分鐘），21:09 抵達 A13 桃園機場第二航廈，搭電梯上 3 樓出境大廳。
  - 21:15 抵達阿聯酋航空 EK 367 報到櫃檯，完成 20 kg 行李托運（截止 22:20）與安檢出境。
  - 風險底線：最晚須搭乘 20:45 機捷直達車（21:24 抵達機場）；晚於此班將大幅壓縮托運排隊時間。
- **網站資料同步**：更新 `site/js/data.js` 的 `days['09-06']`、`routeMaps['09-06']`（新增古亭至桃機路徑與站點地圖）及 `scheduleTiming['09-06']`（對齊飛行時段索引）。

## 行李物品備註更新（2026-09-06）

- **隨身小包・個人日用**：更新「環保餐具」與「摺疊傘」為「環保餐具 (登機要放行李箱)」及「摺疊傘 (登機要放行李箱)」，提示搭機安檢時須放入托運行李箱。
- **後背包・3C／電器**：將「多孔 GaN 充電器」更名為「GaN 充電器」，新增「C-C & A-C 充電線」。
- **後背包・藥品／工具**：新增「指甲剪」。
- **後背包・個人備援**：將「備用信用卡」更名為「備用信用卡 & 行李箱鑰匙」。
- **托運行李箱・衣物**：將「防風防水外套」更名為「Goretex 外套」。
- **隨身小包・個人日用**：新增「自拍棒 (登機要放行李箱)」（自行李箱移入）。
- **後背包・藥品／工具**：新增「行李電子秤」（自行李箱移入）。
- **托運行李箱・行李／其他**：移除「指甲剪」（由後背包攜帶）、「姓名牌」；「行李電子秤」移至後背包，「自拍棒」移至隨身小包。
- **托運行李箱・食品／零食**：新增「泡麵(碗) x4」與「小零食」。
- **行李包款圖示 Emoji 化**：將隨身小包、後背包、托運行李箱各處的圓圈數字標示（①、②、③）更換為醒目易讀的 Emoji（👜、🎒、🧳），並加大字體尺寸。
- **景點頁展開按鈕強化**：將 `places.html` 精簡清單模式下的向下箭頭更換為高對比向量 SVG Chevron，提高深淺色模式與 Android App 中的辨識度與點擊狀態。
- **托運行李箱・洗衣／日用**：將「塑膠袋／環保袋」拆分，並新增獨立項目「大環保袋(咖啡)」。
- **行李頁快速清空與還原功能**：於清單狀態列新增快捷「清空」按鈕，點擊後即刻清空所有已勾選項目，並將按鈕切換為醒目的「還原」狀態供誤觸復原；若隨後勾選任何新項目，按鈕自動重設回「清空」。

## 恢復網站與 APK 內建票券（2026-09-06）

- 使用者明確要求將 11 份 `.enc` 加密票券放回 Git，隨網站部署及 APK 一起提供。這項指示取代先前「不追蹤 `.enc`、每台裝置手動匯入」的規則；原始 PDF、密碼與未遮蔽個資仍不得提交。
- 票券可直接開啟，沿用原密碼與指紋設定，不必重新匯入。網頁版會快取加密票券，APK 安裝時已附上所有票券；備用匯入僅供檔案載入異常時使用。
- 每次發版由 `scripts/sync-version.cjs` 依票券檢查碼清單產生 Service Worker 的票券快取清單；隱私檢查改為驗證已授權的加密檔案、排除原始 PDF 並保留個資遮蔽。

## Android 長按選字背景修正（2026-09-06）

- 將 Android 主題的全域 `android:background` 改為 `android:windowBackground`，避免頁面底色套到選字游標與原生浮動選單的容器，造成大面積白底。
- 保留 Android 原生選字操作，包含複製、分享、全選及系統提供的其他項目；實際排列與可用項目由 Android／Samsung WebView 決定。視窗與系統列的背景依系統明暗模式設定。
- 新增 Android 資源回歸測試，檢查淺色、深色及啟動畫面的主題不會替原生彈窗、游標容器加上不透明背景；APK 發布前執行此檢查。

## 手機操作與新功能改善（2026-09-06）

### 導覽與每日行程

- 手機頁首改為搜尋按鈕，全站保留總覽、景點、交通、行李、小工具五項底部導覽。
- 首頁與每日頁提供「現在的安排／接下來」，依各地時區判斷。跨夜航班以出發與抵達時間銜接；畫面只代表行程安排，不是即時位置或班次動態。
- 日期切換放在前面，時間軸提供導航與票券按鈕，並以文字區分憑證和彈性選項。當日簡介、地圖、交通細節與地點筆記可展開查看，連結會自動展開目標區塊。
- 首頁日期選單與城市摘要使用中文短名，完整行程保留外文名稱，方便對照地圖。
- 回到頁面時恢復捲動與展開狀態，有指定錨點時優先前往目標。滑動換頁避開按鈕、地圖和橫向選單，取消的手勢不換頁。手機保留安全邊距，鍵盤開啟時隱藏底部導覽，並支援鍵盤焦點提示與減少動態效果設定。

### 隨身資訊與私人票券

- 「隨身資訊」集中顯示所選日期的票券、當晚住宿及歐洲緊急聯絡；可複製地址、導航或撥打電話。
- `.enc` 加密票券隨網站與 APK 提供，可直接出示；開啟時仍需密碼或已設定的指紋。備用匯入檔通過雜湊比對後存於本機 IndexedDB。
- 姓名、訂單 PIN 與訂位識別資料維持遮蔽，原始 PDF 不提交。重新加密時同步更新檢查碼，並將新版加密檔隨網站及 APK 發布。

### 交通、景點與行李

- 交通頁預設為「當日資訊」，集中顯示票券、住宿和航班，可複製地址或導航。手機透過分類選單切換完整資料，並記住日期與分類。9/12 寄物提醒沿用主方案：優先 CPH 機場，中央車站為備案。
- 景點精簡清單先顯示中文名，再顯示外文名。較長的中文名會換行，導航與展開按鈕加大，搜尋文字和篩選會在本次瀏覽中保留。
- 行李頁預設顯示「還沒收」，記住包款、篩選及收合狀態，收齊後可切回全部核對。手機直接顯示四個包款篩選，不必橫向滑動。
- 分裝說明和登機限制放在清單下方；編輯、同步與重設收在「編輯與備份」。確認視窗支援明暗主題、Back 和 Escape，取消不會更改清單。

### 小工具與離線準備

- 小工具一次顯示翻譯、匯率、天氣、推薦 App 或設定其中一項。預設翻譯，記住所選分頁；既有網址錨點仍可開啟指定工具。
- 切換工具保留尚未送出的輸入內容。離開翻譯、切到背景或離開頁面時停止相機，行李 QR 掃描也會釋放相機。
- 設定頁實際檢查行程快取、裝置票券與 Android 翻譯語言包。地圖底圖和即時天氣需要網路，站點順序可離線讀取，匯率使用上次成功取得的資料。
- Android 載入 APK 內建資源，不註冊網頁更新用的 Service Worker。PWA 首次完成快取不強制重整，新版下載完成後由使用者套用；無法檢查更新時提示重試。
...
- **First Camp Sibbarp-Malmö 訂房確認與時段約定**：
  - 預訂確認編號：`5398******`（PIN 碼：`****`），全額已付訖（SEK 5,036.25）。
...
- **👜 隨身小包（14 項，劃分 3 組）**：
  ...
  - **個人日用**（7 項）：袖珍包衛生紙 ×2、摺疊傘 (登機要放行李箱)、保溫瓶、原子筆、口罩、環保餐具 (登機要放行李箱)、自拍棒 (登機要放行李箱)。
- **🎒 後背包（19 項，劃分 4 組）**：
  - **3C／電器**（7 項）：MacBook、iPad、Sony WH-1000XM6 耳機、3.5 mm 飛機耳機線、GaN 充電器、C-C & A-C 充電線、轉接頭。
  - **藥品／工具**（6 項）：普拿疼、過敏藥、腸胃藥、剪刀（剪刀刀刃長度須在 6 cm 內且為圓頭／安全剪刀）、指甲剪、行李電子秤。
  - **機上／保暖**（4 項）：旅行頸枕、遮光眼罩、發熱衣 ×1、保暖外套。
  - **個人備援**（2 項）：備用眼鏡、備用信用卡 & 行李箱鑰匙。
- **🧳 托運行李箱（37 項，劃分 7 組）**：
  - **衣物**（9 項）：短袖 ×7、發熱衣 ×1、長褲 ×4、正式衣服一套、內褲 ×5、襪子 ×7、睡衣 ×3、Goretex 外套、藍白拖。
  - **盥洗**（6 項）：牙刷、牙膏、洗髮精、沐浴乳、刮鬍刀、梳子。
  - **洗衣／日用**（8 項）：塑膠袋、大環保袋(咖啡)、洗衣袋、洗衣精、毛巾、晾衣繩、晾衣架、S 掛鉤。
  - **電器**（6 項）：延長線 ×2、轉接頭 ×3、備用豆腐頭 ×2、無線充電盤、熱水瓶、吹風機。
  - **文件／備援**（4 項）：護照影本、保險影本、身分證影本、2 寸照片。
  - **行李／其他**（2 項）：行李束帶、時鐘。
  - **食品／零食**（2 項）：泡麵(碗) x4、小零食。
- 全站行李清單 70 項全數具備分類標題（Group），在手機與電腦版面上皆以獨立區塊呈現，方便逐區點收。
...
- 票面、座位與時間軸已正式核對同步（2026-09-04）：
  ...
  - **羅浮宮入場時間**：官方 4 人預約憑證確認為 09/16 16:30，時間軸已優化為 15:10 到 15:50 杜樂麗花園周邊咖啡輕食休整、16:00 抵達金字塔預約隊伍報到安檢、16:30 依票面入場看展至 20:30。
...
- 09/16 凱旋門門票時間為 10:50、羅浮宮為 16:30 入場（16:00 報到）；採 08:25 飯店出發搭 M2 → 09:05-09:45 在地烘焙坊 Julambre（33 Rue Lauriston）享用可頌咖啡輕食 → 10:00 抵達走地下通道至凱旋門外觀拍照與排隊 → 10:50 門票入場登頂 284 階俯瞰放射大道 → 12:00-13:40 Champs-Élysées 向東漫步（含 PSG 旗艦店梅西紀念品尋寶、平價午餐、52 號 Monoprix 採買補水）→ 13:40-14:00 Place de la Concorde 歷史地標拍照 → 14:00-15:10 Jardin des Tuileries 水池綠椅休閒漫步（登頂後恢復）→ 15:10-15:50 花園周邊咖啡甜點小憩與輕食補給、裝滿水瓶 → 16:00 金字塔預約通道報到排隊 → 16:30 到 20:30 Louvre 參觀（B1 先取語音導覽，直取維納斯、勝利女神、蒙娜麗莎與迦拿婚禮、梅杜薩之筏三寶名作，夜間延長至 21:00，20:30 清場）→ 20:30-20:45 Cour Napoléon 金字塔點燈夜景 → 20:45 後周邊享用正式晚餐，搭 M1＋M4 回住宿。
...
- 興趣優先級：**科技／互動體驗 > 美食 > 城市地標／建築 > 傳統博物館 > 自然／海景**。
- 方案抉擇順位：**個人興趣優先 ➔ 地理順向（單向不折返） ➔ 少轉乘 ➔ 步數合理（10,000-15,000 步） ➔ 充分休息 ➔ 知名但無趣的純觀光打卡點**。
- 節奏：休閒、偏輕度；每天約 2 到 3 個重點，把通勤與休息算進去。
- 區域集中與單向推進：景點按區域歸納，行程沿單一方向流暢推進，徹底避免市區來回折返與多餘的跨城移動（拒絕在地圖上隨機散落景點與折返受苦）。
- 交通原則：**少轉一次車，比省約 10 分鐘更重要**；寧可多坐同一班車，避免在複雜的地鐵／火車系統中穿梭轉乘障礙賽。
- 步行：一般以每日約 10,000 到 15,000 步較舒服，盡量不超過 20,000 步。
- 怕熱與避暑：行程主動保留室內、咖啡館、商場、博物館、喝水與休息空間。
- Copenhagen 從 Malmö 往返：最多安排兩天，避免跨海通勤過多。
- ECCV 錨點：以 ECCV 2026（尤其 09/10 發表日）為行程支柱，觀光不得干擾研討會議程。
- Tivoli 重點：園區氣氛、復古燈光、拍照與餐飲，不以刺激遊樂設施為主。
- 餐飲條件：偏好肉類（牛排、牛肉、豬肉），海鮮次之；平常輕鬆吃，整趟安排 1 到 2 餐特別聚餐；優先支援 Visa／Mastercard 刷卡，不依賴現金或冷門在地支付。
...
| 日期 | 城市 | 住宿／預約 | 關鍵資訊 |
| --- | --- | --- | --- |
| 09/07-09/12 | Malmö | First Camp Sibbarp-Malmö | Strandgatan 101；09/07 15:00 起（約定 18:00-19:00 抵達），09/12 11:00 前退房；獨立小木屋 Cottage（4 人），退房前需自行清潔或付費清潔；聯絡電話 +46 40 15 51 65；訂單編號 5398****** (PIN: ****) |
...
| 09/16 | Paris | 08:25 出發 → 09:05 Julambre 烘焙坊早餐 → 10:50 凱旋門登頂 284 階 → Champs-Élysées（PSG 梅西尋寶／午餐／Monoprix 補水）→ 13:40 協和廣場 → 14:00 杜樂麗花園 → 15:10 咖啡輕食休整 → 16:00 金字塔報到 → 16:30-20:30 羅浮宮（B1 領導覽機／鎮館名作）→ 20:30 金字塔夜景 → 20:45 正式晚餐 |
...
- 09/16 08:25 從住宿出發搭地鐵 M2 直達 Charles de Gaulle-Étoile，09:05 到 09:45 先至 33 Rue Lauriston 在地烘焙坊 Julambre 享用可頌與黑咖啡輕食早餐；09:45 啟程並於 10:00 抵達凱旋門，切記走地下人行通道（嚴禁橫越路面圓環），於 10:50 門票時間前拍照與排隊安檢，登頂爬 284 階旋轉梯俯瞰巴黎放射大道與鐵塔全景；12:00 到 13:40 沿香榭麗舍向東漫步（含走訪 PSG 旗艦店尋找梅西 30 號時期紀念小物、大道平價午餐、52 號 Monoprix 採買補水與點心）；13:40 到 14:00 協和廣場方尖碑與噴泉拍照；14:00 到 15:10 杜樂麗花園悠閒漫步與水池綠椅休息；15:10 到 15:50 於周邊享用咖啡與輕食墊胃並補滿飲水；16:00 準時至羅浮宮金字塔預約通道排隊安檢，16:30 依指定時段入館，先至地下負一層領取已訂購之語音導覽，專注參觀米洛的維納斯、勝利女神、蒙娜麗莎（含背後《迦拿的婚禮》）、梅杜薩之筏與拿破崙三世套房，配合週三夜間開放至 20:30 清場前逛紀念品店；離館後在拿破崙庭院拍玻璃金字塔夜景，20:45 後於周邊享用正式晚餐，搭 M1＋M4 回飯店。
...
- 完整 70 項互動式行李清單在網站的行李頁；本檔只保留分裝決策與維護規則。
- FR9267 免費隨身件目前按 40 × 30 × 20 cm 規劃；貼身小包在登機口前收進後背包。
- FR9267 托運上限為每人 20 kg；封箱目標 18 kg，保留餘量。
- 打包原則：護照、付款工具、藥品、電腦與行動電源一律放身上／後背包，不放托運；剪刀與指甲剪放入托運行李箱；其中行動電源依航空規則不得托運。
- 完整 70 項互動式行李清單在網站的行李頁；本檔只保留分裝決策與維護規則。
...
- **👜 隨身小包（15 項，分 3 組）**（每天出門會背，重要＋隨時會用）：
  - **證件／財物**：護照、主要信用卡、歐元現金、錢包、房卡／住宿鑰匙。現金與卡片放身上，不放托運箱。
  - **隨身 3C**：手機、行動電源。行動電源依航空規定必須隨身客艙攜帶、嚴禁托運；搭 FR9267 到登機口前，整個小包收進後背包。
  - **個人日用**：袖珍包衛生紙 ×2、摺疊傘 (登機要放行李箱)、保溫瓶、原子筆、口罩、環保餐具 (登機要放行李箱)、自拍棒 (登機要放行李箱)、飲料提袋。
- **🎒 後背包（16 項，分 4 組）**（飛機、機場、火車、飯店會用，或貴重不能托運）：
  - **3C／電器**：MacBook、Sony WH-1000XM6 耳機、3.5 mm 飛機耳機線、GaN 充電器、C-C & A-C 充電線、轉接頭。
  - **藥品／工具**：普拿疼、過敏藥、腸胃藥、行李電子秤。藥品與電子秤隨身。
  - **機上／保暖**：旅行頸枕、遮光眼罩、發熱衣 ×1、保暖外套。
  - **個人備援**：備用眼鏡、備用信用卡 & 行李箱鑰匙。備用信用卡與鑰匙隨身不放托運；這是 FR9267 唯一免費隨身件，裝滿後需符合 40 × 30 × 20 cm。
- **🧳 托運行李箱（39 項，分 7 組）**（衣服、生活用品、電器集中處）：
  - **衣物**：短袖 7 件、發熱衣 1 件、長褲 4 條、正式衣服一套、內褲 5 件、襪子 7 雙、睡衣 3 套、Goretex 外套、藍白拖。
  - **盥洗**：牙刷、牙膏、洗髮精、沐浴乳、刮鬍刀、梳子。
  - **洗衣／日用**：塑膠袋、大環保袋(咖啡)、洗衣袋、洗衣精、毛巾、晾衣繩、晾衣架、S 掛鉤。
  - **電器**：延長線 2 條、轉接頭 3 顆、備用豆腐頭 2 顆、無線充電盤、熱水瓶、吹風機。
  - **文件／備援**：護照影本、保險影本、身分證影本、2 寸照片。
  - **行李／其他**：行李束帶、時鐘、剪刀、指甲剪。
  - **食品／零食**：泡麵(碗) x4、小零食。封箱目標 18 kg、FR9267 上限 20 kg，以 9/12 Ryanair 為打包約束。
